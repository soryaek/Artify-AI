  ...
  return (
    <section className='max-w-7xl mx-auto text-center'>
      <div>
        ...
        <p className="mt-2 text-[#666e75] text-[11px] sm:text-[14px]">Explore a gallery of creative and visually captivating images brought to life by Stable Diffusion AI v1.4</p>
      </div>
