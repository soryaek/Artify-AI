  ...
  return (
    <section className="max-w-7xl mx-auto">
       <div className="text-center">
        <h1 className="font-bold text-[#222328] text-[24px] sm:text-[32px]">Welcome to Artify AI!</h1>
        <p className="mt-2 text-[#666e75] text-[11px] sm:text-[14px] max-w-[700px]">From Imagination to Image - Let AI Bring Your Ideas to Life</p>
      </div>
      <form className="mt-8 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          />
           <FormField
            labelName="Create Your Prompt Here"
            type="text"
            name="prompt"
          ...
          <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex items-center justify-center sm:justify-start mx-auto sm:mx-0">
            {form.photo ? (
              ...
              <img src={preview} alt="preview" className="w-9/12 h-9/12 object-contain opacity-40 mx-auto block" />
            )}
